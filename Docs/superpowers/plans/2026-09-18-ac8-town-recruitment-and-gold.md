...
- [x] AC8.4: [Ownership verified](../../Specs/AC8/Evidence/AC8.4/verification.md); [AC8.6 evidence](../../Specs/AC8/Evidence/AC8.6/verification.md) completes current-v1 filtered offers at all seven towns before/after Continue without topology changes. Habitat-enabled worlds later use explicit generated ownership through the same rule.
...
- [x] AC8.6: Whole-roster canonical filtering, passed-out membership, final-representative removal, refresh after recruitment/dismissal/replacement/reload, empty offers and stale requests [verified](../../Specs/AC8/Evidence/AC8.6/verification.md). The [focused plan](2026-09-20-ac8-6-whole-roster-eligibility.md) additionally delivers the user-requested standalone dismissal extension under its single D1 minimum-one-member/no-refund policy; that extension is not a new base AC8.6 requirement.
