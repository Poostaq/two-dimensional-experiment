...
Plan: [AC8 implementation plan](../superpowers/plans/2026-09-18-ac8-town-recruitment-and-gold.md). AC8.1-AC8.3 are implemented and verified. AC8.4 ownership and habitat/debug presentation are complete as recorded below; its filtered-offer requirement and AC8.5-AC8.8 remain unchecked. See [AC8.2 evidence](AC8/Evidence/AC8.2/verification.md) and [AC8.3 evidence](AC8/Evidence/AC8.3/verification.md).
...
| `AC8.4 / AC8.4a` | Ownership prerequisite PASS; full criterion incomplete | [Ownership evidence](AC8/Evidence/AC8.4/verification.md) verifies all v1 towns, town-only errors and unchanged topology after reload. Filtered offers remain pending AC8.5/AC8.6; generated explicit ownership remains AC9. The broader AC8.4 checkbox stays unchecked until its remaining contract passes. |
