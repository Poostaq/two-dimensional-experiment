...
| `AC1.2` | Determinism check | Start two runs with the same Run ID and confirm the Safe/Combat/Boss hex layout is identical; start a run with a different Run ID and confirm the layout can differ. |
