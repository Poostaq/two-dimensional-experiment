...
Implementation status reviewed on 2026-09-20: AC8.1-AC8.3, the AC8.4 town-ownership prerequisite, the current-habitat/world-debug-drawer expansion, and current-world AC8.5 town recruitment are implemented and verified. Full AC8.4 recruitment eligibility, AC8.6-AC8.8 and AC9-AC10 remain incomplete; their unchecked criteria below define planned behavior. They replace reward-choice recruitment and move-count-based Sudden Death. Cross-run progression and unrelated AC5 questions remain deferred.
...
Plan: [AC8 implementation plan](../superpowers/plans/2026-09-18-ac8-town-recruitment-and-gold.md). AC8.1-AC8.3 and current-world AC8.5 are implemented and verified. AC8.4 ownership and habitat/debug presentation are complete as recorded below; its full filtered-offer requirement and AC8.6-AC8.8 remain unchecked. See [AC8.2 evidence](AC8/Evidence/AC8.2/verification.md), [AC8.3 evidence](AC8/Evidence/AC8.3/verification.md), and [AC8.5 evidence](AC8/Evidence/AC8.5/verification.md).
...
| `AC8.4 / AC8.4a` | Ownership prerequisite PASS; full criterion incomplete | [Ownership evidence](AC8/Evidence/AC8.4/verification.md) verifies all v1 towns, town-only errors and unchanged topology after reload. AC8.5 verifies current-town offers; the full AC8.6 eligibility matrix remains pending, and generated explicit ownership remains AC9. The broader AC8.4 checkbox stays unchecked until its remaining contract passes. |
...
| `AC8.6-AC8.8` | Full eligibility and transaction acceptance pending | Extend the existing `Tests/WorldMap/test_ac8_town_recruitment.gd` coverage for whole-roster exclusion including passed-out members, refresh after dismissal/replacement/reload, empty offers, stale requests, capacity, cancellation, failed-save retry, duplicate settlement and actual ruins rejection. AC8.5 supporting checks do not replace these full matrices. |
